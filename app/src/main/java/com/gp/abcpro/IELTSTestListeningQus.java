...
public class IELTSTestListeningQus extends AppCompatActivity {

    TextView questionTV, questionNum;
    Button a1, a2, a3, a4;
    ...
    private void setDataToViews(int currentPos) {
        if (questionsAtt == 11) {
            Intent intent = new Intent(IELTSTestListeningQus.this, IELTSTest2.class);
